...
#################################################### Config START ####################################################
code_dir="/gpfs/group/pipkin/Goldrath_RNAseq/codes"
wkdir="/gpfs/group/pipkin/Goldrath_RNAseq"
...
metab=ascii.read("/gpfs/group/pipkin/Goldrath_RNAseq/Info/Names.csv")
...
renameBYlistreplacement(inputList,outputList,wkdir)
