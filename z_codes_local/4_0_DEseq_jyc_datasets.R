...
wkdir <- "/Users/yolandatiao/Desktop/jycATAC/HTseqCount/jyc"
setwd(wkdir)
...
write.csv(all.df, file="jyc.all.df.max.csv")

all.df.numx <- cbind(all.df.numx, max.num)
write.csv(all.df.numx, file="jyc.all.df.int.max.csv")

all.df.numx.c5 <- subset(all.df.numx, all.df.numx$max.num >=5 )
all.df.numx.c5$max.num <- NULL
write.csv(all.df.numx.c5, file="jyc.all.df.int.max.c5.csv")

########## 4 DEseq
all.df.numx.c5 <- read.csv("jyc.all.df.int.max.c5.csv")
...
write.csv( Bcl6KO_Th1_vs_Naive ,"all.df.numx.c5-Bcl6KO_Th1_vs_Naive.csv")
write.csv( DKO_Th1_vs_Naive ,"all.df.numx.c5-DKO_Th1_vs_Naive.csv")
write.csv( WT_Th1_vs_Naive ,"all.df.numx.c5-WT_Th1_vs_Naive.csv")
write.csv( DKO_Tfh_vs_Naive ,"all.df.numx.c5-DKO_Tfh_vs_Naive.csv")
write.csv( Prdm1KO_Tfh_vs_Naive ,"all.df.numx.c5-Prdm1KO_Tfh_vs_Naive.csv")
write.csv( STAT4_KO_Tfh_vs_Naive ,"all.df.numx.c5-STAT4_KO_Tfh_vs_Naive.csv")
write.csv( STAT4_WT_Tfh_vs_Naive ,"all.df.numx.c5-STAT4_WT_Tfh_vs_Naive.csv")
write.csv( WT_Tfh_vs_Naive ,"all.df.numx.c5-WT_Tfh_vs_Naive.csv")
write.csv( Bcl6KO_Th1_vs_WT_Th1 ,"all.df.numx.c5-Bcl6KO_Th1_vs_WT_Th1.csv")
write.csv( DKO_Th1_vs_WT_Th1 ,"all.df.numx.c5-DKO_Th1_vs_WT_Th1.csv")
write.csv( DKO_Tfh_vs_WT_Tfh ,"all.df.numx.c5-DKO_Tfh_vs_WT_Tfh.csv")
write.csv( Prdm1KO_Tfh_vs_WT_Tfh ,"all.df.numx.c5-Prdm1KO_Tfh_vs_WT_Tfh.csv")
write.csv( STAT4_KO_Tfh_vs_WT_Tfh ,"all.df.numx.c5-STAT4_KO_Tfh_vs_WT_Tfh.csv")
write.csv( STAT4_WT_Tfh_vs_WT_Tfh ,"all.df.numx.c5-STAT4_WT_Tfh_vs_WT_Tfh.csv")
write.csv( DKO_Tfh_vs_WT_Th1 ,"all.df.numx.c5-DKO_Tfh_vs_WT_Th1.csv")
write.csv( Prdm1KO_Tfh_vs_WT_Th1 ,"all.df.numx.c5-Prdm1KO_Tfh_vs_WT_Th1.csv")
write.csv( STAT4_KO_Tfh_vs_WT_Th1 ,"all.df.numx.c5-STAT4_KO_Tfh_vs_WT_Th1.csv")
write.csv( STAT4_WT_Tfh_vs_WT_Th1 ,"all.df.numx.c5-STAT4_WT_Tfh_vs_WT_Th1.csv")
write.csv( WT_Tfh_vs_WT_Th1 ,"all.df.numx.c5-WT_Tfh_vs_WT_Th1.csv")
write.csv( Bcl6KO_Th1_vs_WT_Tfh ,"all.df.numx.c5-Bcl6KO_Th1_vs_WT_Tfh.csv")
write.csv( DKO_Th1_vs_WT_Tfh ,"all.df.numx.c5-DKO_Th1_vs_WT_Tfh.csv")
...
write.csv( DKO_Tfh_vs_Prdm1KO_Tfh ,"all.df.numx.c5-DKO_Tfh_vs_Prdm1KO_Tfh.csv")
write.csv( DKO_Th1_vs_Bcl6KO_Th1 ,"all.df.numx.c5-DKO_Th1_vs_Bcl6KO_Th1.csv")
