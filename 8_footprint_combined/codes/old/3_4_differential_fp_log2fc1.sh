...
wk_dir=/home/pipkin/Documents/jycATAC_footprint2/3_log2fc-1_slt_merged
bam_dir=/home/pipkin/Documents/jycATAC_footprint2/source
mpbs_dir=/home/pipkin/Documents/jycATAC_footprint2/2_log2fc-1_slt_merged
...
rgt-hint differential --organism=mm10 --output-profiles --nc=2 --mpbs-file1=$mpbs_dir/WT_Tfh_mpbs_DKOTfh_mergedupdn.bed --mpbs-file2=$mpbs_dir/WT_Tfh_mpbs_DKOTfh_mergedupdn.bed --reads-file1=$bam_dir/WT_Tfh.dupr.srt.bam --reads-file2=$bam_dir/DKO_Tfh.dupr.srt.bam --output-location=$wk_dir/WT-Tfh_DKO-Tfh_pval --output-prefix WT-Tfh_DKO-Tfh_DKO_pval --condition1=WT --condition2=KO &
rgt-hint differential --organism=mm10 --output-profiles --nc=2 --mpbs-file1=$mpbs_dir/WT_Tfh_mpbs_PKO_mergedupdn.bed --mpbs-file2=$mpbs_dir/WT_Tfh_mpbs_PKO_mergedupdn.bed --reads-file1=$bam_dir/WT_Tfh.dupr.srt.bam --reads-file2=$bam_dir/Prdm1KO_Tfh.dupr.srt.bam --output-location=$wk_dir/WT-Tfh_PKO-Tfh_pval --output-prefix WT-Tfh_PKO-Tfh_PKO_pval --condition1=WT --condition2=KO &
rgt-hint differential --organism=mm10 --output-profiles --nc=2 --mpbs-file1=$mpbs_dir/WT_Th1_mpbs_BKO_mergedupdn.bed --mpbs-file2=$mpbs_dir/WT_Th1_mpbs_BKO_mergedupdn.bed --reads-file1=$bam_dir/WT_Th1.dupr.srt.bam --reads-file2=$bam_dir/Bcl6KO_Th1.dupr.srt.bam --output-location=$wk_dir/WT-Th1_BKO-Th1_pval --output-prefix WT-Th1_BKO-Th1_BKO_pval --condition1=WT --condition2=KO &
rgt-hint differential --organism=mm10 --output-profiles --nc=2 --mpbs-file1=$mpbs_dir/WT_Th1_mpbs_DKOTh1_mergedupdn.bed --mpbs-file2=$mpbs_dir/WT_Th1_mpbs_DKOTh1_mergedupdn.bed --reads-file1=$bam_dir/WT_Th1.dupr.srt.bam --reads-file2=$bam_dir/DKO_Th1.dupr.srt.bam --output-location=$wk_dir/WT-Th1_DKO-Th1_pval --output-prefix WT-Th1_DKO-Th1_DKO_pval --condition1=WT --condition2=KO &
rgt-hint differential --organism=mm10 --output-profiles --nc=3 --mpbs-file1=$mpbs_dir/WT_Tfh_mpbs_TfhTh1_mergedupdn.bed --mpbs-file2=$mpbs_dir/WT_Tfh_mpbs_TfhTh1_mergedupdn.bed --reads-file1=$bam_dir/WT_Tfh.dupr.srt.bam --reads-file2=$bam_dir/WT_Th1.dupr.srt.bam --output-location=$wk_dir/WT_Tfh_TfhTh1_pval --output-prefix WT_Tfh_TfhTh1_pval --condition1=WT-Tfh --condition2=WT-Th1
wait
