...
fastq_end1=$INDIR/SRR6248862_1.fastq
fastq_end2=$INDIR/SRR6248862_2.fastq
#fastqc $fastq_end1
#fastqc $fastq_end2
...
trim_fastq_end1=$INDIR/SRR6248862_1_val_1.fq
trim_fastq_end2=$INDIR/SRR6248862_2_val_2.fq
...
bowtie2_cmd_1="bowtie2 -p 1 -x $bowtie2_index_mm10 -X 2000 --fr"
...
##### Convert/sort/filter
bam_name=SRR6248862.bam
bam_name_srt=SRR6248862_srt.bam
bam_name_srt_dupr=SRR6248862_srt_dupr.bam
