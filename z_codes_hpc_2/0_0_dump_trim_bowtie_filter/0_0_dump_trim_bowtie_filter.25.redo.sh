...
#fastq_end1=$INDIR/SRR6248879_1.fastq
#fastq_end2=$INDIR/SRR6248879_2.fastq
#fastqc $fastq_end1
#fastqc $fastq_end2
...
#trim_fastq_end1=$INDIR/SRR6248879_1_val_1.fq
#trim_fastq_end2=$INDIR/SRR6248879_2_val_2.fq
...
##### Convert/sort/filter
bam_name=SRR6248879.bam
bam_name_srt=SRR6248879_srt.bam
bam_name_srt_dupr=SRR6248879_srt_dupr.bam
