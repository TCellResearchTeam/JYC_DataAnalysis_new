...
#fastq_end1=$INDIR/SRR6248871_1.fastq
#fastq_end2=$INDIR/SRR6248871_2.fastq
#fastqc $fastq_end1
#fastqc $fastq_end2
...
trim_fastq_end1=$INDIR/SRR6248871_1_val_1.fq
trim_fastq_end2=$INDIR/SRR6248871_2_val_2.fq
...
##### Convert/sort/filter
bam_name=SRR6248871.bam
bam_name_srt=SRR6248871_srt.bam
bam_name_srt_dupr=SRR6248871_srt_dupr.bam
